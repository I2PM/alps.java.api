...
public interface IPASSProcessModelElementFactory<T extends IParseablePASSProcessModelElement> {
     ...
     */
    IParseablePASSProcessModelElement createInstance(Map<String, List<Pair<ITreeNode<IParseablePASSProcessModelElement>, Integer>>> parsingDict, List<String> names);
