...
@Override
    ...
    public ChoiceSegmentPath(ISubjectBehavior behavior){
            super(behavior);
                ...
                setIsOptionalToEndChoiceSegmentPath(null);
                setIsOptionalToStartChoiceSegmentPath(null);
            }
    ...
    public void setContainedStates(Set<IState> containedStates, int removeCascadeDepth) {
        for(IState state: getContainedStates())
        {
...
@Override
    ...
    public boolean getContainedBy(out IChoiceSegment choiceSegment) {
