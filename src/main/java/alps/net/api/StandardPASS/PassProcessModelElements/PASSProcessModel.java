...
import alps.net.api.ALPS.ALPSModelElements.ALPSSIDComponents.ISubjectExtension;
import alps.net.api.ALPS.ALPSModelElements.ALPSSIDComponents.SubjectExtension;
import alps.net.api.ALPS.ALPSModelElements.ALPSSIDComponents.SubjectExtensions.GuardExtension;
import alps.net.api.ALPS.ALPSModelElements.ALPSSIDComponents.SubjectExtensions.MacroExtension;
import alps.net.api.ALPS.ALPSModelElements.IModelLayer;
import alps.net.api.ALPS.ALPSModelElements.ModelLayer;
import alps.net.api.FunctionalityCapsules.IImplementsFunctionalityCapsule;
import alps.net.api.FunctionalityCapsules.ImplementsFunctionalityCapsule;
...
import alps.net.api.StandardPASS.PassProcessModelElements.BehaviorDescribingComponents.States.IStateReference;
import alps.net.api.StandardPASS.PassProcessModelElements.InteractiondescribingComponents.IMessageExchange;
...
import alps.net.api.StandardPASS.PassProcessModelElements.SubjectBehaviors.IGuardBehavior;
import alps.net.api.StandardPASS.PassProcessModelElements.SubjectBehaviors.IMacroBehavior;
import alps.net.api.parsing.IPASSGraph;
import alps.net.api.parsing.IParseablePASSProcessModelElement;
...
/// <summary>
    ...
    public class PASSProcessModel extends PASSProcessModelElement, implements IPASSProcessModel
        ...
        protected boolean justAddElement(IPASSProcessModelElement pASSProcessModelElement)
                {
                if (pASSProcessModelElement == null) { return false; }
        ...
        @Override
        protected boolean parseAttribute(String predicate, String objectContent, String lang, sSring dataType, IParseablePASSProcessModelElement element)
                {
