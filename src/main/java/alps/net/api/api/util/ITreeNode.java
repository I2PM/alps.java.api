 ...
 *
 * @param <T> the type of the content of the tree node
 */
public interface ITreeNode<T> {
     ...
     * @param node a reference to a node that will be set to the found node if this method returns true
     ...
     * @return true if it is a sublass of the specified parent, false if not
     */
     ...
     *
     * @return the height of the longest path to a leaf
     */
